...
echo 'networking/idmsvr/CentOsX86-64/Dockerfile' >> .git/info/sparse-checkout
echo 'networking/idmsvr/README.md' >> .git/info/sparse-checkout

## Download with pull, not clone
git pull origin main

echo 'cd into idmsvr/networking/idmsvr/CentOsX86-64 and view details in Dockerfile for building, running, and attaching to the container'
